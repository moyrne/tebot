...
func (l *Limiter) Rate(ctx context.Context, name string, quid int64) error {
	result, err := l.limiter.Allow(ctx, "analyze_"+name+"_"+strconv.Itoa(int(quid)), redis_rate.PerMinute(3))
	if err != nil {
