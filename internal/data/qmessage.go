...
var _ cqhttp.QMessageRepo = &QMessageData{}

// QMessageData 聊天记录持久化
type QMessageData struct{}

func (q *QMessageData) Save(ctx context.Context, tx dbx.Transaction, m *cqhttp.QMessage) error {
...
func (q *QMessageData) SetReply(ctx context.Context, tx dbx.Transaction, id int64, reply string) error {
